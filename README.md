...
> **In the wild.** [OpenWurli](https://github.com/openwurli/openwurli) — a Wurlitzer 200A virtual instrument — ships a plugin whose entire DSP engine is generated by melange. (Melange was originally extracted out of that project; see [Origin](#origin).)

> **Status: early alpha.** Several classic circuits are validated and working (Pultec EQP-1A, Wurlitzer 200A, tweed preamp, Tube Screamer). Others are under active development. See the [circuits table](#circuits) for per-circuit status.
...
Melange was extracted from the [OpenWurli](https://github.com/openwurli/openwurli) project, a Wurlitzer 200A virtual instrument. The relationship now runs both ways: melange grew out of OpenWurli, and OpenWurli's shipping plugin is in turn generated by melange.
