                ...
                if has_sections {
                    ...
                    code.push_str(&format!(
                        "{indent}let glow_lit{d} = state.device_{d}_state[0] >= 0.5;\n\
                         ...
                         {indent}    glow_lit_eval(v_d{s}, DEVICE_{d}_V0, DEVICE_{d}_RT, &[DEVICE_{d}_K1, DEVICE_{d}_K2, DEVICE_{d}_K3, DEVICE_{d}_K4], &[DEVICE_{d}_K1M, DEVICE_{d}_K2M, DEVICE_{d}_K3M, DEVICE_{d}_K4M], &glow_i_bar{d}, DEVICE_{d}_IFLOOR, DEVICE_{d}_KSUB, DEVICE_{d}_I_N)\n\
                         {indent}}} else {{\n\
